       ...
       <Typography  sx={{ mb:1 }}>Calculadora</Typography>  
            <Grid container  direction="column" spacing={2} alignItems="center">
                ...
                <ButtonGroup variant="outlined" aria-label="outlined button group" fullWidth>
                    ...
                    <Button style={{fontSize:'14px', background:'#eeeeee'}} name="*" onClick={handleClick} className="boton" >*</Button>
                </ButtonGroup>
                <ButtonGroup variant="outlined" aria-label="outlined button group" fullWidth>
                ...
                <ButtonGroup variant="outlined" aria-label="outlined button group" fullWidth>
                    ...
                    <Button style={{fontSize:'14px', background:'#eeeeee'}} name="." onClick={handleClick} className="botones" >.</Button>
                    <Button style={{fontSize:'14px', background:'#eeeeee'}} onClick={calcular} className="botones">=</Button>
                </ButtonGroup>
            </Grid>
